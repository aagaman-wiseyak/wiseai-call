...
class IntentRouterService:
    ...
    async def route_intent(
        ...
        system_prompt = (
            ...
            "   - E.g. If customer confirms or agrees, map to the positive or booking action branch.\n"
            "   - E.g. If customer objects on cost, timing, or qualifications, map to the matching rebuttal branch.\n"
            "   - E.g. If customer indicates specific needs or answers a qualifying question, map to that specific path branch.\n"
            "   - E.g. If customer declines or rejects, map to the exit or callback branch.\n"
