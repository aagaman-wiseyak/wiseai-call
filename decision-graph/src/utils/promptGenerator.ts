...
export function generateCampaignFromPrompt(userPrompt: string): GeneratedCampaign {
  ...
  const rawNodes: CustomFlowNode[] = [
    {
      ...
      data: {
        ...
        openingScript: `Hi {{lead_name}}, this is ${agentName} with ${company} regarding your ${service}. Got a quick second?`,
        voiceStyle: 'Professional & warm',
        enableAmd: true,
        voicemailScript: `Hi {{lead_name}}, ${agentName} from ${company} regarding your ${service}. Please give us a quick callback. Thanks!`,
      },
    },
    {
      id: 'node-vm-hangup',
    ...
    },
    {
      ...
      data: {
        ...
        speechPrompt: `We have you down for next week. Does that time still work for you?`,
    ...
    },
    {
      ...
      data: {
        ...
        rebuttalScript: `Most routine visits are 100% covered under preventive plans. Would you like us to double-check yours?`,
    ...
    },
    {
      ...
      data: {
        ...
        closingScript: `All set, {{lead_name}}! See you then. Have a great day.`,
    ...
    },
    {
      ...
      data: {
        type: 'hangup',
        label: 'Reschedule Exit',
        closingScript: `No problem at all! Just texted you the link to pick a time. Talk soon!`,
    ...
    },
    {
      ...
      data: {
        type: 'hangup',
        label: 'Opt-Out Exit',
        closingScript: `Understood. Thanks for letting us know. Have a good day.`,
  ...
  const rawEdges: CustomFlowEdge[] = [
    ...
    },
    {
      ...
      data: { label: 'Confirmed', color: '#10b981' },
    },
    {
      id: 'e-r-cost',
      source: 'node-scenario-router',
      ...
      data: { label: 'Cost Concern', isObjection: true, color: '#f59e0b' },
    },
    {
      ...
      target: 'node-action-confirm',
      data: { label: 'Reassurance Accepted', isReturn: true, color: '#10b981' },
    },
    {
      id: 'e-r-resched',
      source: 'node-scenario-router',
      ...
      data: { label: 'Needs Reschedule', color: '#3b82f6' },
    },
    {
      id: 'e-r-cancel',
      source: 'node-scenario-router',
